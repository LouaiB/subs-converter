...
let test1 = function CONVERTWEBVTT2OBJ_IDENTIFIEREXISTS_CORRECTIDENTIFIER(){
    const obj = webvtt2obj.convert(webvtt);
...
let test2 = function CONVERTWEBVTT2OBJ_TIMESTAMPS_CORRECTPARSING(){
    const obj = webvtt2obj.convert(webvtt);
...
let test3 = function CONVERTWEBVTT2OBJ_TEXTLINES_CORRECTPARSING(){
    const obj = webvtt2obj.convert(webvtt);
...
let test4 = function CONVERTWEBVTT2OBJ_IDENTIFIERDOESNOTEXIST_CONVERTIONSUCCEEDS(){
    const obj = webvtt2obj.convert(webvtt2);
